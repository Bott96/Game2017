...
public class InfoSinglePlayerScreen implements Screen {
	...
	public InfoSinglePlayerScreen(final AttacksAndConquers attacksAndConquers, MainMenuScreen main) {
		...
		Uno = Risorse.assets.get(Risorse.UnoSingleP);
	...
	public void render(float delta) {
		...
		if(pagineCorrente < 5){
			if (Gdx.input.getX() < Gdx.graphics.getWidth() / 2 + BUTTON_WIDTH + 5
					...
					&& attacksAndConquers.height - Gdx.input.getY() < Gdx.graphics.getHeight() / 2 - Uno.getHeight() / 2 + 5
							+ BUTTON_HEIGHT
