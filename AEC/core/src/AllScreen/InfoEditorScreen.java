...
public class InfoEditorScreen implements Screen {
	...
	public InfoEditorScreen(final AttacksAndConquers attacksAndConquers, MainMenuScreen main) {
		...
		Uno = Risorse.assets.get(Risorse.UnoEditor);
		Due = Risorse.assets.get(Risorse.DueEditor);
		Tre = Risorse.assets.get(Risorse.TreEditor);
		Quattro = Risorse.assets.get(Risorse.QuattroEditor);
	...
	public void render(float delta) {
		...
		if(pagineCorrente < 4){
			if (Gdx.input.getX() < Gdx.graphics.getWidth() / 2 + BUTTON_WIDTH + 5
					...
					&& attacksAndConquers.height - Gdx.input.getY() < Gdx.graphics.getHeight() / 2 - Uno.getHeight() / 2 - 15
							+ BUTTON_HEIGHT
				...
				attacksAndConquers.batch.draw(FrecciaAvantiA, Gdx.graphics.getWidth() / 2 + 5,
						Gdx.graphics.getHeight() / 2 - Uno.getHeight() / 2 - 15, BUTTON_WIDTH, BUTTON_HEIGHT);
